...
final class FetchConfig
{
     ...
     *
     * @return FetchConfig<
     *     ($config is null ? Data : (MergedData is mixed|empty ? Data : MergedData)),
     *     ($config is null ? TransportRequest : (MergedTransportRequest is mixed|empty ? TransportRequest : MergedTransportRequest)),
     *     ($config is null ? TransportResponse : (MergedTransportResponse is mixed|empty ? TransportResponse : MergedTransportResponse))
     * >
     */
